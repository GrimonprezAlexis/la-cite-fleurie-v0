                      ...
                      <div className="max-w-5xl mx-auto flex flex-col items-center">
                        <div className="mb-4 md:mb-6 animate-scale-in">
                          <Image
                            ...
                            width={700}
                            height={467}
                            className="w-[180px] sm:w-[280px] md:w-[400px] lg:w-[550px] h-auto object-contain drop-shadow-[0_35px_60px_rgba(211,203,194,0.9)] hover:scale-105 transition-transform duration-500"
                            priority
                          />
                        </div>
                        <p className="text-xl sm:text-2xl md:text-3xl mb-8 md:mb-12 animate-slide-up font-light tracking-wide flex items-center gap-3 md:gap-4" style={{animationDelay: '0.2s'}}>
