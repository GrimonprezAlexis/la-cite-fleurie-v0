                    ...
                    <div className="container mx-auto px-4 text-center text-white">
                      <div className="max-w-5xl mx-auto">
                        <div className="mb-4 animate-scale-in flex justify-center">
                          <Image
                            src="/ChatGPT Image 8 oct. 2025, 12_41_19.png"
                            alt="La Cité Fleurie"
                            width={800}
                            height={600}
                            className="w-[400px] sm:w-[500px] md:w-[650px] lg:w-[800px] h-auto object-contain drop-shadow-[0_35px_60px_rgba(211,203,194,0.9)] hover:scale-105 transition-transform duration-500"
                            priority
                          />
                        </div>
